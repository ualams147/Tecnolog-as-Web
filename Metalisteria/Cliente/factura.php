...
<head>
    ...
    <style>
        ...
        /* Clase base IDÉNTICA para ambos */
        .btn-base {
            display: inline-flex;       
            align-items: center;        
            justify-content: center;    
            
            /* FORZAMOS ALTURA FIJA PARA QUE SEAN IGUALES */
            height: 50px;              
            line-height: 50px; /* Truco para centrar texto verticalmente */
            ...
            font-weight: 500;
            font-size: 15px; /* Un pelín más pequeño para que quepa bien */
            cursor: pointer;
        ...
        /* Estilos específicos Botón IMPRIMIR */
        .btn-imprimir {
        ...
        /* Estilos específicos Botón VOLVER */
        .btn-inicio {
                ...
                <div style="border-bottom: 2px solid #293661; padding-bottom: 20px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <p style="margin: 5px 0; font-size: 14px; color: #666; font-family: 'Source Sans Pro', sans-serif;">
                            Cortijo la Purisima, 2P<br>18004 Granada<br>Tlf: 652 921 960
                        </p>
                    </div>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-family: 'Source Sans Pro', sans-serif;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #eee;">
                            <td style="padding: 12px; color: #333;"><?php echo htmlspecialchars($item['nombre']); ?></td>
                            <td style="padding: 12px; text-align: center; color: #666;"><?php echo $item['cantidad']; ?></td>
                            <td style="padding: 12px; text-align: right; color: #666;"><?php echo number_format($item['precio'], 2); ?> €</td>
                            <td style="padding: 12px; text-align: right; font-weight: bold; color: #333;"><?php echo number_format($item['precio'] * $item['cantidad'], 2); ?> €</td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
